...
class ProviderSummary extends Mailable
{
    ...
    public function build()
    {
        try {
            ...
            $pdfContent = $pdf->loadView('provider.summary', [
            ...
            return $this->from(env('MAIL_FROM_ADDRESS'))
                ->subject('Rendición de comisiones (Periodo ' . $this->arrayDate['dateFrom'] . ' – ' . $this->arrayDate['dateTo'] . ' )')
                ->view('emails.provider.summary',
                    [
                        'provider' => $this->provider,
                        'dateFrom' => $this->arrayDate['dateFrom'],
                        'dateTo' => $this->arrayDate['dateTo']
